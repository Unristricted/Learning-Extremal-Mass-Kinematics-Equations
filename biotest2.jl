...
#   (B) Force start_system = :polyhedral to avoid polyhedral recursion/stack overflow
#
# Usage:
...
function count_positive_real_solutions(sys::System, pvec::Vector{Float64};
    ...
    # KEY: start_system=:polyhedral avoids the polyhedral recursion you hit
...
# -----------------------------
function probe_C(C::Real; real_tol=1e-8, pos_tol=1e-10, start_system::Symbol=:polyhedral)
    println("\n--- Probe at C = $C ---")
